 ...
 * resident-side certificate dropdown and the admin template list.
 * Excludes the LONGBLOB {@code template_data} — the picker only
 * needs id/name/description/createdAt to render and bind. The blob
 * is loaded later, at issuance time, by the (future) issuance service.
 */
